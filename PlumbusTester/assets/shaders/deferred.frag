...
float shadowProj(vec4 P, vec2 offset, int index)
{
	float shadow = 1.0;
	...
	if (shadowCoord.w > 0.0 && dist + 0.005 < shadowCoord.z)
	{
		shadow = 0;
	}
