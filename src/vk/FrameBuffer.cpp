...
namespace vk
{
	void FrameBuffer::CreateAttachment(VkFormat format, VkImageUsageFlagBits usage, FrameBufferAttachment *attachment)
	{
	...
	void FrameBuffer::PrepareOffscreenFramebuffer()
	{
		...
		// Formats
		attachmentDescs[0].format = m_Position.m_Format;
		attachmentDescs[1].format = m_Normal.m_Format;
		attachmentDescs[2].format = m_Albedo.m_Format;
		attachmentDescs[3].format = m_Depth.m_Format;
		...
		attachments[0] = m_Position.m_ImageView;
		attachments[1] = m_Normal.m_ImageView;
		attachments[2] = m_Albedo.m_ImageView;
		attachments[3] = m_Depth.m_ImageView;
